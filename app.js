...
*/
var redisClient = redis.createClient(6379, 'db');
...
server.listen(port, function() {
              console.log("Starting Parler v0.3.4" + '\n' + "Listening on port " + port);
              });  //listen on port 80
...
app.get('/JavaScript/popup.js', function (req, res) {
        res.sendFile(__dirname + '/HTML/JavaScript/popup.js');
        });
